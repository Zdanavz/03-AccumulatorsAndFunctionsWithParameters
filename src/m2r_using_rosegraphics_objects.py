...
#              Downwards towards the bottom of the screen
#
...
#            Draws all objects attached to the methods
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want to be able to choose when the window closes, otherwise the
#            window will close when it is done running.
#
